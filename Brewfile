...
brew "webp" # New file format for still image compression
...
cask "replacicon" # App icon replacement utility
...
## Utilities
vscode "arcanis.vscode-zipfs" # Easily inspect and modify files stored within zip archives
vscode "christian-kohler.npm-intellisense" # Autocompletes npm modules in import statements
...
vscode "wayou.vscode-todo-highlight" # TODO Highlight
